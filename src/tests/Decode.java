...
public class Decode {
	...
	public static void main(String[] args) throws IOException {
		...
		File fichero = new File("C:\\Users\\juans\\OneDrive\\Documentos\\MEGAsync Downloads\\batman.mp4");
		...
		int actualpart = 0;
		FileWriter fw = new FileWriter("C:\\Users\\juans\\OneDrive\\Escritorio\\xd.txt");
